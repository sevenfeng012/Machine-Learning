...
def train(x_train, y_train, vocab_processor, x_dev, y_dev):
    ...
    print('numclass=={}'.format(y_train.shape[1]))
    with tf.Graph().as_default():
        session_conf = tf.ConfigProto(
          allow_soft_placement=FLAGS.allow_soft_placement,#自动选gpu
          log_device_placement=FLAGS.log_device_placement)#打印gpu日志
...
def main(argv=None):
    x_train,y_train,vocab_processor,x_dev,y_dev = data_helpers.preprocessWidthDir('classification/sample/')
